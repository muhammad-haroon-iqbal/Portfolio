    ...
    return (
        <>
            <div className="max-w-screen-2xl container mx-auto px-4 md:px-20 h-16 shadow-md fixed top-0 left-0 right-0 z-50 bg-white">
                ...
                {menu && (
                    <div className=''>
                        <ul className='md:hidden flex flex-col h-screen justify-center items-center space-y-10  bg-zinc-300/45'>
                            {
                                navItems.map(({ id, text }) => (
                                    <li className='hover:scale-125 font-black text-xl duration-200 cursor-pointer ' key={id}>
                                        <Link
